...
function Client(accessKey, businessId){
  ...
  this.getTemplates = function () {
    return this.getDocuments("templates", 'DocumentTemplate');
  };
  ...
  this.getArchivedTemplates = function () {
    return this.getDocuments("templates_archived", 'DocumentTemplate');
  };
  ...
  this.getDraftTemplates = function () {
    return this.getDocuments("template_drafts", 'DocumentTemplate');
  };
   ...
   * @param {*} limit - Limit.
   * @param {*} page - Page.
   * @param {*} search - Search by name of the file. 
