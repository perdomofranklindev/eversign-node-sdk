...
declare module "eversign-enhance/lib/Client" {
    ...
    class Client {
         ...
         */
        public sendReminderForDocument(
            document: Document,
            signer: Signer
        ): Promise<void>;
        /**
         ...
         *
         */
        public createDocumentFromTemplate(
            template: Template
        ): Promise<Document>;
        /**
         ...
         */
        public downloadFinalDocumentToPath(
            document: Document,
            path: string,
            auditTrail?: boolean
        ): Promise<boolean>;
         ...
         */
        public downloadRawDocumentToPath(
            document: Document,
            path: string
        ): Promise<boolean>;
        ...
        public getDocumentDownloadUrl(
            documentId: string,
            auditTrail?: boolean,
            type?: "download_final_document" | "download_raw_document"
        ): Promise<string>;
        /**
         *
         */
        public generateOAuthAuthorizationUrl(
...
declare module "eversign-enhance/lib/Document" {
    ...
    class Document {
        ...
        public setEmbeddedSigningEnabled(
            newEmbeddedSigningEnabled: boolean
        ): void;
...
declare module "eversign-enhance/lib/NoteField" {
    ...
    interface NoteField
        extends FormField,
            ...
            Readable,
            Requireable,
            Signable {} // Typescript way of typing mixins.
    namespace NoteField {
        interface IObject
            extends FormField.IObject,
                TextFormField.IObject,
                Readable.IObject,
                Requireable.IObject,
                Signable.IObject {
            /**
...
declare module "eversign-enhance/lib/Signer" {
    class Signer {
        ...
        setSignerAuthenticationPhoneNumber(
            newSignerAuthenticationPhoneNumber: string
        ): void;
        setSignerAuthenticationSmsEnabled(
            newSignerAuthenticationSmsEnabled: string
        ): void;
